...
class NeuralNet():
    ...
    def evaluate(self, env, episodes, render_env, record, debug=False):
        ...
        for i_episode in range(episodes):
            ...
            while not done:
                ...
                if len(observation.shape) > 1: observation = observation.flatten()

                observation, r, done, _ = env.step(self.act(np.array(observation)))
                cum_rewards += r
                count += 1
